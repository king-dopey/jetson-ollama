...
- `docker-compose.yml`: Ollama service plus `ollama-warmup` warmup container and optional `ollama-pull-verifier` profile.
...
LibreChat can call Ollama directly by setting base URL to `http://ORIN_IP:11434`.

Per-request keep_alive can be set in payload if your client supports sending it.

## LibreChat Configuration

- Base URL (direct Ollama): `http://ORIN_IP:11434`
- Model IDs:
  - `qwen3-coder:30b`
  - `qwen3.6:35b-a3b`
